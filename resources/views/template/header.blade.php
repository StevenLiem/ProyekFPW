    ...
    <nav class="navbar navbar-expand-lg navbar-dark" style="background-color: #191a1c; border-bottom: 1px solid #158a52;">
        <div class="container-fluid">
            <div href="#" class="navbar-brand mx-3">
                <span style="color: #158a52; font-size: 18px; font-weight: bold;">LOGO HERE</span>
            </div>
                ...
                <div class="navbar-nav ms-auto">
                    <form class="form-inline my-2 my-lg-0" action="/search" method="GET">
                        <div class="input-group">
                            <input type="text" class="form-control shadow-none" placeholder="Search Here" name="title">
